...
$publicLoadOrder = @(
  ...
  'Get-NdsDefaultBackupFolder.ps1',
...
Export-ModuleMember -Function 'Invoke-NetworkPathTuning', 'Get-NdsDefaultBackupFolder', 'Invoke-UdpJitterOptimization', 'Get-UjDefaultBackupFolder', 'Test-UjIsAdministrator'
