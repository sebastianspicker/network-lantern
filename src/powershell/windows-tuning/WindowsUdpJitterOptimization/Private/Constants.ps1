...
$script:UjDefaultBackupFolder = Join-Path -Path $script:UjDefaultBackupFolderBase -ChildPath 'NetworkDiagnosticsSuite'
...
$script:UjManagedQosNamePrefixes = @('NDS_QOS_PORT_', 'NDS_QOS_APP_', 'QoS_UDP_TS_', 'QoS_UDP_CS2_', 'QoS_APP_')
